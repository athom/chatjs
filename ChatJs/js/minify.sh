...
cp jquery.chatjs.min.js $GOPATH/src/github.com/theplant/qortex/assets/javascripts/plugins/chatjs/js
cp ../css/jquery.chatjs.css $GOPATH/src/github.com/theplant/qortex/assets/javascripts/plugins/chatjs/css
